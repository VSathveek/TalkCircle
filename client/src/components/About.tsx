const About = () => {
    return (
        <div className="relative w-[100vw] font-mono min-h-[calc(100vh-4rem)] bg-[#000000] flex flex-col justify-center items-center gap-[2rem]">
                <h2 className="max-w-[95%] text-[1.5rem] font-bold text-center">Why talkCircle’s Architecture Stands Out</h2>
            ...
            <div className="relative bottom-[1rem] w-full text-center text-white font-semibold">Made by V Sathveek</div>
        </div>
    )
}
